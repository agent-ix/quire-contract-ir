...
| FR-038 | FR-038-AC-1 through FR-038-AC-11, FR-038-AC-16, FR-038-AC-17 | TC-048, TC-050, TC-052 | ✅ implemented by Contract IR PR #107/#108 for issue #106 and re-pinned to QSpec `0c7497ee0f7c99b2c6fd69b283c314edbe53a1bb` for issue #109 (FR-208 eighteen-meaning model vocabulary, node `declaration`, literal `type`, application `operation`/`result_type`, three added positive fixtures, and structural admission of `state`/`frame` bodies): strict reader with typed version refusal and independent lowering; AC-7 and AC-8 added for the closed seven-member record vocabulary and the total outcome-selection order, AC-9 for the shipped finite default read-limit policy, AC-10 for the `model_selections` `uniqueItems` refusal, AC-11 for its array-position-independent precedence over the evidence check, AC-16 for the re-pinned vendor set and re-derived package ids, AC-17 for the new declared wire members entering the identity projection and the closed model/expression form lists. Frame-body eligibility, canonical member order and refusal precedence (FR-340) are not part of this FR; a later issue owns them. |

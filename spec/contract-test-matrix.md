...
| FR-031 | FR-031-AC-1 through FR-031-AC-4 | TC-042, TC-221 | 🚧 AC-1 and AC-2 implemented through native replay PR #92 and codegen corpus PR #47: module dispatch refuses cross-family approximation and every generated artifact binds its provenance. AC-3 planned as TC-221 (issue #137): the evaluated witness the criterion names is never produced from a Kani transcript, and the test `tc_042_counterexample_replays_through_native_runtime_execute` supplies `reconstruct` as `\|_\|`, which discards the packet and returns a constant input. AC-4, the witness vocabulary AC-3 consumes, is added; implemented by IR #139 |
...
| TC-221 | Kani counterexample replay through the complete-V1 executor conforms | Integration | P0 | FR-031-AC-3, FR-031-AC-4 | 🚧 planned (issue #137); no case yet carries a witness extracted from a Kani transcript |

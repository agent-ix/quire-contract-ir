...
- A request-bound, pure Rust OCL 2.4 correspondence catalog and mapper for the
  accepted bounded invariant/pre/post fragment, with whole-obligation refusal
  rather than approximate target text.
...
without target approximation or foreign-runtime qualification.
